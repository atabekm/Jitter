...
public class Constants {
    ...
    public static final String TWITTER_USERNAME_PATTERN = "([A-Za-z]|[0-9]|\\_)+";
    public static final int TWITTER_USERNAME_MIN_LENGTH = 2;
    public static final int TWITTER_USERNAME_MAX_LENGTH = 15;
}
